...
class Library: ObservableObject {
    ...
    init() {
        ...
        // Code from the lab was giving errors, used chat gpt to fix the issues.
        
        for (title, authData) in bookData {
            if let genderEnum = Gender(rawValue: authData[1]) {
    ...
    func addBook(title: String, author: String, gender: Gender, displayed: Bool) {
